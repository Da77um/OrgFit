...
const ar = {
  ...
  download: "تنزيل",
  print: "طباعة",
  printHint: "يفتح التقرير في نافذة جديدة؛ اطبعه من عارض المتصفح أو بالضغط على Ctrl+P (أو Cmd+P).",
...
const en: Record<ResultsKey, string> = {
  ...
  download: "Download",
  print: "Print",
  printHint: "Opens the report in a new tab; print it from the browser's viewer or with Ctrl+P (Cmd+P).",
